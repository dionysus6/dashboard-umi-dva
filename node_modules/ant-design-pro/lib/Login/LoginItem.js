...
var WarpFormItem = function (_Component) {
  _inherits(WarpFormItem, _Component);

  function WarpFormItem(props) {
    _classCallCheck(this, WarpFormItem);

    var _this = _possibleConstructorReturn(this, (WarpFormItem.__proto__ || Object.getPrototypeOf(WarpFormItem)).call(this, props));
    ...
    _this.getFormItemOptions = function (_ref) {
      ...
      var options = {
        rules: rules || _this.customprops.rules
      };
      if (onChange) {
...
Object.keys(_map2.default).forEach(function (key) {
  ...
  LoginItem[key] = function (props) {
    return _react2.default.createElement(
      ...
      null,
      function (context) {
        return _react2.default.createElement(WarpFormItem, _extends({
