...
var Excrption = (_temp = _class = function (_React$PureComponent) {
  _inherits(Excrption, _React$PureComponent);

  function Excrption(props) {
    _classCallCheck(this, Excrption);

    var _this = _possibleConstructorReturn(this, (Excrption.__proto__ || Object.getPrototypeOf(Excrption)).call(this, props));

    _this.state = {};
    return _this;
  }

  _createClass(Excrption, [{
    key: 'render',
    value: function render() {
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['className', 'backText', 'linkElement', 'type', 'title', 'desc', 'img', 'actions']);
